...
class Filter:
    ...
    async def inlet(
        ...
        body["metadata"]["trace_user_id"] = __user__["name"]
...
class EventEmitter:
    ...
    async def progress_update(self, description):
        await self.emit(description, status="in_progress", done=False)

    async def error_update(self, description):
        await self.emit(description, "error", True)

    async def success_update(self):
        await self.emit("", "success", True)
